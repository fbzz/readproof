...
// it from here. A record that says "produced by readproof 0.3.0" is only
// useful if every producer agrees on what 0.3.0 means, and separate
// literals drift.
package version
...
// String is the human-facing build identity: "0.3.0", or "0.3.0+a1b2c3d"
