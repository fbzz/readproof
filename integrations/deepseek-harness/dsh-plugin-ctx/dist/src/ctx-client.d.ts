 ...
 */
export declare function startRun(client: Ctx, runId: string): Promise<void>;
export declare function mountRun(client: Ctx, runId: string, uri: string): Promise<{
    position: number;
    resolve: ResolveResult;
}>;
export declare function commitRun(client: Ctx, runId: string): Promise<Manifest>;
//# sourceMappingURL=ctx-client.d.ts.map